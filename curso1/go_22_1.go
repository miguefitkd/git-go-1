...
// ExecuteGoCap22Ej1 hace tal cosa.
func ExecuteGoCap22Ej1() {
	fmt.Printf("\n\nExecuteGoCap22Ej1 <=== ****\n")

	// Archivo respecto de la ubicacion del main.
	// ejecucion := readFile2("./test_1_no_existe.csv")
	ejecucion := readFile2("./curso1/test_1.csv")
...
func readFile2(pathFile string) bool {
	// Abrir un archivo
